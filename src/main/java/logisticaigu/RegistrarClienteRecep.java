 ...
 * @author ULTRA
 */
public class RegistrarClienteRecep extends javax.swing.JFrame {
     private ControladoraCliente controladoraCliente;
     private Paquete paqueteTemporal;
     private String rolUsuario;
    /**
     * Creates new form RegistrarClienteRecep
     */
    public RegistrarClienteRecep(Paquete paqueteTemporal, String rolUsuario) {
        initComponents();
...
private boolean camposLlenos() {
    ...
    if (camposLlenos()) {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            BuscarClienteReceptor buscarClienteReceptor = new BuscarClienteReceptor(paqueteTemporal, rolUsuario);
            buscarClienteReceptor.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     BuscarClienteReceptor atras = new BuscarClienteReceptor(paqueteTemporal, rolUsuario);
