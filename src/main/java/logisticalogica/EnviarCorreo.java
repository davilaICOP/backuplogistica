...
public class EnviarCorreo {
    private static String username = "encomiedaspatria@gmail.com"; // Coloca tu correo electrónico aquí
    private final String password = "ixnkvwkgykjyuwth"; // Coloca tu contraseña aquí
